...
<head>
    ...
    <script src="js/retrurnWarning.js"></script>
    <title>주부들의 쉼터</title>
  ...
  ?>
    ...
    <form class="container-fluid pt-0 section" action="upload.php" method="post" enctype="multipart/form-data" id="myForm">
            ...
            <div id="material-group" class="row">
                <div class="container text-center col-md-6 boxed">주재료
                    ...
                    <div id="button-aria" class="d-flex justify-content-center mt-2">
                        <button type="button" id="addButton1" class="btn-gradient green mini">추가하기</button>
                    </div>
                </div>
                <div class="container text-center col-md-6">부재료
                    ...
                    <div class="row material-main2 d-flex flex-column-reverse ">
                        <div id="button-aria" class="d-flex justify-content-center mt-2">
                            <button type="button" id="addButton2" class="btn-gradient green mini">추가하기</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container bg-white mt-4">
            ...
            <div id="button-aria" class="d-flex justify-content-center mt-2">
                <button id="addStepBtn" class="btn-gradient green mini">추가하기</button>
            </div>

        </div>
        <div class="container d-flex justify-content-end mb-5"><button type="button" onclick="insert()" class=" btn-gradient green" >전송</button></div>
    </form>
